...
public class TestController {
	 ...
	 * @return 请求的路径
	 */
	@ApiDocsMethod(requestBean = com.github.wangmingchang.automateapidocs.pojo.apidocs.vo.PageDto.class, baseResponseBean=BaseResponseVo.class ,responseBean = DemoVo.class)
	@RequestMapping("/ht")
